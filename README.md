...
1. [Estrutura de um Programa em C](#estrutura-de-um-programa-em-c)
2. [Declaração de Variáveis](#declaração-de-variáveis)
3. [Tipos Numéricos em C](#tipos-numéricos-em-c)
   - [char](#char)
   - [short](#short)
   - [int](#int)
   - [long](#long)
   ...
   - [double](#double)
4. [Funções](#funções)
   - [Definição e Declaração](#definição-e-declaração)
...
5. [Comandos vs. Expressões](#comandos-vs-expressões)
   - [Comandos](#comandos)
...
8. [Entrada e Saída](#entrada-e-saída)
   - [printf](#printf)
   - [scanf](#scanf)
   - [Códigos de Formatação](#códigos-de-formatação)
9. [Estruturas de Dados](#estruturas-de-dados)
   - [Arrays](#arrays)
   - [Strings](#strings)
   - [Structs](#structs)
10. [Manipulação de Memória](#manipulação-de-memória)
    - [Apontadores](#apontadores)
    - [Alocação Dinâmica de Memória](#alocação-dinâmica-de-memória)
      - [malloc](#malloc)
      - [calloc](#calloc)
      - [realloc](#realloc)
11. [Recursividade](#recursividade)
12. [Ordenação e Pesquisa](#ordenação-e-pesquisa)
